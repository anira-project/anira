...
phases or contracts and on an inference thread in others (a stage callback, the six context
accessors and the two default bodies it may call). For an entry under it the generator
