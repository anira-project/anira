...
.. js:autoclass:: AniraWeb.AniraWeb
   :short-name:
   :members: create, stackRestore, malloc, free, getMemory, getWasmInstance, allocWasmString, registerProcessor, registerPrePostProcessor, unregisterPrePostProcessor, getActiveWorkers, spinUpInferenceWorker, registerAudioWorkletForContext, configureAudioWorklet
