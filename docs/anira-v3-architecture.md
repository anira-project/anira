...
- tanh-tooling v0.1.6 re-pinned by anira and tanh-lib together. (The tanh-lib option `TANH_LOG_COMPILED_MAX_LEVEL` landed early, with tanh-lab/tanh-lib#37, and anira uses it.)
