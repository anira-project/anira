...
#endif
#if MODEL_TO_USE == 7
        LATENT_0_ID = {"param_latent_0", 1}, LATENT_1_ID = {"param_latent_1", 1},
        LATENT_2_ID = {"param_latent_2", 1}, LATENT_3_ID = {"param_latent_3", 1},
#endif
        BACKEND_TYPE_ID = {"param_backend_type", 1}, DRY_WET_ID = {"param_mix", 1};
...
#endif
#if MODEL_TO_USE == 7
        LATENT_0_NAME = "Latent 0", LATENT_1_NAME = "Latent 1", LATENT_2_NAME = "Latent 2",
...
#if MODEL_TO_USE == 7
    inline static juce::AudioParameterFloatAttributes latentAttributes =
        juce::AudioParameterFloatAttributes()
            .withStringFromValueFunction([](float x, auto) { return juce::String(x, 2); })
            .withLabel("Offset");
#endif

    inline static juce::AudioParameterFloatAttributes percentage_attributes =
        juce::AudioParameterFloatAttributes().withStringFromValueFunction(
            [](float x, auto) { return juce::String(x * 100.f, 0) + " %"; });

    inline static juce::AudioParameterFloatAttributes db_attributes =
        juce::AudioParameterFloatAttributes().withStringFromValueFunction([](float x, auto) {
