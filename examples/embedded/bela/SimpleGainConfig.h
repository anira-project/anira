...
#ifdef USE_LIBTORCH
    {BELA_MODELS_PATH + std::string("/simple_gain_network_mono.pt"), anira::InferenceBackend::LIBTORCH},
#endif
#ifdef USE_ONNXRUNTIME
    {BELA_MODELS_PATH + std::string("/simple_gain_network_mono.onnx"), anira::InferenceBackend::ONNX},
#endif
#ifdef USE_TFLITE
    {BELA_MODELS_PATH + std::string("/simple_gain_network_mono.tflite"), anira::InferenceBackend::TFLITE},
#endif
};
