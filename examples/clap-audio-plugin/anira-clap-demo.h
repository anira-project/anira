...
struct AniraClapPluginExample
    ...
    enum ParamIds : uint32_t { pmDryWet = 14256, pmBackend = 14257 };
...
private:
    ...
    enum Backend { OnnxRuntime, LibTorch, TensorFlowLite, Bypassed, LiteRt, ExecuTorch };
};
