...
int main(void) {
    ...
    entries[56].name = "anira_handler_pop_data_f32";
    entries[56].address = (uintptr_t)&anira_handler_pop_data_f32;
    entries[57].name = "anira_handler_pop_data_f32_multi";
    entries[57].address = (uintptr_t)&anira_handler_pop_data_f32_multi;
    entries[58].name = "anira_handler_pop_data_f32_multi_wait";
    entries[58].address = (uintptr_t)&anira_handler_pop_data_f32_multi_wait;
    entries[59].name = "anira_handler_pop_data_f32_wait";
    entries[59].address = (uintptr_t)&anira_handler_pop_data_f32_wait;
    entries[60].name = "anira_handler_prepare";
    entries[60].address = (uintptr_t)&anira_handler_prepare;
    entries[61].name = "anira_handler_process_f32";
    entries[61].address = (uintptr_t)&anira_handler_process_f32;
    entries[62].name = "anira_handler_process_f32_inplace";
    entries[62].address = (uintptr_t)&anira_handler_process_f32_inplace;
    entries[63].name = "anira_handler_process_f32_inplace_wait";
    entries[63].address = (uintptr_t)&anira_handler_process_f32_inplace_wait;
    entries[64].name = "anira_handler_process_f32_multi";
    entries[64].address = (uintptr_t)&anira_handler_process_f32_multi;
    entries[65].name = "anira_handler_process_f32_multi_wait";
    entries[65].address = (uintptr_t)&anira_handler_process_f32_multi_wait;
    entries[66].name = "anira_handler_process_f32_wait";
    entries[66].address = (uintptr_t)&anira_handler_process_f32_wait;
    entries[67].name = "anira_handler_push_data_f32";
    entries[67].address = (uintptr_t)&anira_handler_push_data_f32;
    entries[68].name = "anira_handler_push_data_f32_multi";
    entries[68].address = (uintptr_t)&anira_handler_push_data_f32_multi;
    ...
    entries[72].name = "anira_has_core";
    entries[72].address = (uintptr_t)&anira_has_core;
    entries[73].name = "anira_inference_thread_create";
    entries[73].address = (uintptr_t)&anira_inference_thread_create;
    entries[74].name = "anira_inference_thread_destroy";
    entries[74].address = (uintptr_t)&anira_inference_thread_destroy;
    entries[75].name = "anira_inference_thread_execute";
    entries[75].address = (uintptr_t)&anira_inference_thread_execute;
    entries[76].name = "anira_inference_thread_has_exited";
    entries[76].address = (uintptr_t)&anira_inference_thread_has_exited;
    entries[77].name = "anira_inference_thread_is_running";
    entries[77].address = (uintptr_t)&anira_inference_thread_is_running;
    entries[78].name = "anira_inference_thread_run_loop";
    entries[78].address = (uintptr_t)&anira_inference_thread_run_loop;
    entries[79].name = "anira_inference_thread_should_exit";
    entries[79].address = (uintptr_t)&anira_inference_thread_should_exit;
    entries[80].name = "anira_inference_thread_start";
    entries[80].address = (uintptr_t)&anira_inference_thread_start;
    entries[81].name = "anira_inference_thread_stop";
    entries[81].address = (uintptr_t)&anira_inference_thread_stop;
    entries[82].name = "anira_job_options_create";
    entries[82].address = (uintptr_t)&anira_job_options_create;
    entries[83].name = "anira_job_options_destroy";
    entries[83].address = (uintptr_t)&anira_job_options_destroy;
    entries[84].name = "anira_job_options_set_below_min";
    entries[84].address = (uintptr_t)&anira_job_options_set_below_min;
    entries[85].name = "anira_job_options_set_ext";
    entries[85].address = (uintptr_t)&anira_job_options_set_ext;
    entries[86].name = "anira_job_options_set_ext_json";
    entries[86].address = (uintptr_t)&anira_job_options_set_ext_json;
    entries[87].name = "anira_job_options_set_head_trim";
    entries[87].address = (uintptr_t)&anira_job_options_set_head_trim;
    entries[88].name = "anira_job_options_set_tail_flush";
    entries[88].address = (uintptr_t)&anira_job_options_set_tail_flush;
    entries[89].name = "anira_log";
    entries[89].address = (uintptr_t)&anira_log;
    entries[90].name = "anira_log_rt";
    entries[90].address = (uintptr_t)&anira_log_rt;
    entries[91].name = "anira_model_config_add_input";
    entries[91].address = (uintptr_t)&anira_model_config_add_input;
    entries[92].name = "anira_model_config_add_model_bytes";
    entries[92].address = (uintptr_t)&anira_model_config_add_model_bytes;
    entries[93].name = "anira_model_config_add_model_bytes_custom";
    entries[93].address = (uintptr_t)&anira_model_config_add_model_bytes_custom;
    entries[94].name = "anira_model_config_add_model_path";
    entries[94].address = (uintptr_t)&anira_model_config_add_model_path;
    entries[95].name = "anira_model_config_add_model_path_custom";
    entries[95].address = (uintptr_t)&anira_model_config_add_model_path_custom;
    entries[96].name = "anira_model_config_add_output";
    entries[96].address = (uintptr_t)&anira_model_config_add_output;
    entries[97].name = "anira_model_config_create";
    entries[97].address = (uintptr_t)&anira_model_config_create;
    entries[98].name = "anira_model_config_destroy";
    entries[98].address = (uintptr_t)&anira_model_config_destroy;
    entries[99].name = "anira_model_config_from_json";
    entries[99].address = (uintptr_t)&anira_model_config_from_json;
    entries[100].name = "anira_model_config_from_json_file";
    entries[100].address = (uintptr_t)&anira_model_config_from_json_file;
    entries[101].name = "anira_model_config_model_bytes";
    entries[101].address = (uintptr_t)&anira_model_config_model_bytes;
    entries[102].name = "anira_model_config_model_count";
    entries[102].address = (uintptr_t)&anira_model_config_model_count;
    entries[103].name = "anira_model_config_model_engine";
    entries[103].address = (uintptr_t)&anira_model_config_model_engine;
    entries[104].name = "anira_model_config_model_engine_id";
    entries[104].address = (uintptr_t)&anira_model_config_model_engine_id;
    entries[105].name = "anira_model_config_model_path";
    entries[105].address = (uintptr_t)&anira_model_config_model_path;
    entries[106].name = "anira_model_config_set_anchor";
    entries[106].address = (uintptr_t)&anira_model_config_set_anchor;
    entries[107].name = "anira_model_config_set_default_engine";
    entries[107].address = (uintptr_t)&anira_model_config_set_default_engine;
    entries[108].name = "anira_model_config_set_default_engine_custom";
    entries[108].address = (uintptr_t)&anira_model_config_set_default_engine_custom;
    entries[109].name = "anira_model_config_set_ext";
    entries[109].address = (uintptr_t)&anira_model_config_set_ext;
    entries[110].name = "anira_model_config_set_ext_json";
    entries[110].address = (uintptr_t)&anira_model_config_set_ext_json;
    entries[111].name = "anira_model_config_set_max_instances";
    entries[111].address = (uintptr_t)&anira_model_config_set_max_instances;
    entries[112].name = "anira_model_config_set_model_bytes";
    entries[112].address = (uintptr_t)&anira_model_config_set_model_bytes;
    entries[113].name = "anira_model_config_set_model_ext";
    entries[113].address = (uintptr_t)&anira_model_config_set_model_ext;
    entries[114].name = "anira_model_config_set_model_ext_json";
    entries[114].address = (uintptr_t)&anira_model_config_set_model_ext_json;
    entries[115].name = "anira_model_config_set_state";
    entries[115].address = (uintptr_t)&anira_model_config_set_state;
    entries[116].name = "anira_model_config_set_tensor_layout";
    entries[116].address = (uintptr_t)&anira_model_config_set_tensor_layout;
    entries[117].name = "anira_model_config_set_tensor_name";
    entries[117].address = (uintptr_t)&anira_model_config_set_tensor_name;
    entries[118].name = "anira_model_config_take_legacy_contract";
    entries[118].address = (uintptr_t)&anira_model_config_take_legacy_contract;
    entries[119].name = "anira_model_config_to_json";
    entries[119].address = (uintptr_t)&anira_model_config_to_json;
    entries[120].name = "anira_now_ms";
    entries[120].address = (uintptr_t)&anira_now_ms;
    entries[121].name = "anira_now_ns";
    entries[121].address = (uintptr_t)&anira_now_ns;
    entries[122].name = "anira_num_inference_threads";
    entries[122].address = (uintptr_t)&anira_num_inference_threads;
    entries[123].name = "anira_pipeline_add_inference";
    entries[123].address = (uintptr_t)&anira_pipeline_add_inference;
