...
int main(void) {
    ...
    entries[30].name = "anira_context_drain_log";
    entries[30].address = (uintptr_t)&anira_context_drain_log;
    entries[31].name = "anira_context_num_inference_threads";
    entries[31].address = (uintptr_t)&anira_context_num_inference_threads;
    ...
    entries[38].name = "anira_contract_from_json";
    entries[38].address = (uintptr_t)&anira_contract_from_json;
    entries[39].name = "anira_contract_get_kind";
    entries[39].address = (uintptr_t)&anira_contract_get_kind;
    entries[40].name = "anira_contract_hard_set_budget";
    entries[40].address = (uintptr_t)&anira_contract_hard_set_budget;
    entries[41].name = "anira_contract_hard_set_geometry";
    entries[41].address = (uintptr_t)&anira_contract_hard_set_geometry;
    entries[42].name = "anira_contract_hard_set_on_miss";
    entries[42].address = (uintptr_t)&anira_contract_hard_set_on_miss;
    entries[43].name = "anira_contract_hard_set_ring_dtype";
    entries[43].address = (uintptr_t)&anira_contract_hard_set_ring_dtype;
    entries[44].name = "anira_contract_hard_set_wait_ratio";
    entries[44].address = (uintptr_t)&anira_contract_hard_set_wait_ratio;
    entries[45].name = "anira_contract_hard_set_warmup";
    entries[45].address = (uintptr_t)&anira_contract_hard_set_warmup;
    entries[46].name = "anira_contract_set_edge_cost";
    entries[46].address = (uintptr_t)&anira_contract_set_edge_cost;
    entries[47].name = "anira_contract_set_ext";
    entries[47].address = (uintptr_t)&anira_contract_set_ext;
    entries[48].name = "anira_contract_set_ext_json";
    entries[48].address = (uintptr_t)&anira_contract_set_ext_json;
    entries[49].name = "anira_drain_log";
    entries[49].address = (uintptr_t)&anira_drain_log;
    entries[50].name = "anira_enabled_backends";
    entries[50].address = (uintptr_t)&anira_enabled_backends;
    entries[51].name = "anira_has_core";
    entries[51].address = (uintptr_t)&anira_has_core;
    entries[52].name = "anira_inference_thread_create";
    entries[52].address = (uintptr_t)&anira_inference_thread_create;
    entries[53].name = "anira_inference_thread_destroy";
    entries[53].address = (uintptr_t)&anira_inference_thread_destroy;
    entries[54].name = "anira_inference_thread_execute";
    entries[54].address = (uintptr_t)&anira_inference_thread_execute;
    entries[55].name = "anira_inference_thread_has_exited";
    entries[55].address = (uintptr_t)&anira_inference_thread_has_exited;
    entries[56].name = "anira_inference_thread_is_running";
    entries[56].address = (uintptr_t)&anira_inference_thread_is_running;
    entries[57].name = "anira_inference_thread_run_loop";
    entries[57].address = (uintptr_t)&anira_inference_thread_run_loop;
    entries[58].name = "anira_inference_thread_should_exit";
    entries[58].address = (uintptr_t)&anira_inference_thread_should_exit;
    entries[59].name = "anira_inference_thread_start";
    entries[59].address = (uintptr_t)&anira_inference_thread_start;
    entries[60].name = "anira_inference_thread_stop";
    entries[60].address = (uintptr_t)&anira_inference_thread_stop;
    entries[61].name = "anira_job_options_create";
    entries[61].address = (uintptr_t)&anira_job_options_create;
    entries[62].name = "anira_job_options_destroy";
    entries[62].address = (uintptr_t)&anira_job_options_destroy;
    entries[63].name = "anira_job_options_set_below_min";
    entries[63].address = (uintptr_t)&anira_job_options_set_below_min;
    entries[64].name = "anira_job_options_set_ext";
    entries[64].address = (uintptr_t)&anira_job_options_set_ext;
    entries[65].name = "anira_job_options_set_ext_json";
    entries[65].address = (uintptr_t)&anira_job_options_set_ext_json;
    entries[66].name = "anira_job_options_set_head_trim";
    entries[66].address = (uintptr_t)&anira_job_options_set_head_trim;
    entries[67].name = "anira_job_options_set_tail_flush";
    entries[67].address = (uintptr_t)&anira_job_options_set_tail_flush;
    entries[68].name = "anira_log";
    entries[68].address = (uintptr_t)&anira_log;
    entries[69].name = "anira_log_rt";
    entries[69].address = (uintptr_t)&anira_log_rt;
