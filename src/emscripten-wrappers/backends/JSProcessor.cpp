...
public:
    JSProcessor(anira::InferenceConfig& inference_config)
    ...
    void wasm_process(std::vector<anira::BufferF>& input, std::vector<anira::BufferF>& output,
    ...
    void process(std::vector<anira::BufferF>& input, std::vector<anira::BufferF>& output,
        ...
        process_buffers_js(reinterpret_cast<uintptr_t>(this), reinterpret_cast<uintptr_t>(&input), reinterpret_cast<uintptr_t>(&output));
    }
};
