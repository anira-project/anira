...
if (MSVC)
    if (EXISTS "C:/Program Files (x86)/Intel/oneAPI/mkl/latest/lib/intel64")
        target_link_directories(torch INTERFACE "C:/Program Files (x86)/Intel/oneAPI/mkl/latest/lib/intel64")
...
elseif(APPLE)
    if (CMAKE_OSX_ARCHITECTURES STREQUAL "x86_64")
        if (EXISTS "/opt/intel/oneapi/mkl/latest/lib")
            target_link_directories(torch INTERFACE "/opt/intel/oneapi/mkl/latest/lib")
            message(STATUS "Intel MKL library found at /opt/intel/oneapi/mkl/latest/lib")
        endif()
    elseif (CMAKE_OSX_ARCHITECTURES STREQUAL "arm64")
