...
if(EXISTS ${ONNXRUNTIME_ROOTDIR}/)
    ...
    if(EMSDK_VERSION)
        ...
        set(LIBONNXRUNTIME_URL "https://github.com/Andonvr/ONNXRuntime-Static-WASM-Builds/releases/download/emsdk-${EMSDK_VERSION}-onnx-v${LIBONNXRUNTIME_VERSION}/onnx-v${LIBONNXRUNTIME_VERSION}-emsdk-${EMSDK_VERSION}.zip")
    else()
        if(WIN32)
