...
struct ANIRA_API HostAudioConfig {
    ...
    HostAudioConfig(size_t host_buffer_size, double host_sample_rate, std::function<bool(int number_of_tasks)> submit_task_to_host_thread) : m_host_buffer_size(host_buffer_size), m_host_sample_rate(host_sample_rate), submit_task_to_host_thread(submit_task_to_host_thread) {}
