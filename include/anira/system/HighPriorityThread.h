...
/**
 * @brief Abstract base class for creating high-priority threads optimized for real-time audio
 * processing
 *
...
public:
     ...
     * @param is_main_process Whether this is the main process thread (affects priority level on
     * some platforms)
     *
...
protected:
    std::atomic<bool> m_is_running;  ///< Atomic flag indicating whether the thread is currently
                                     ///< running
