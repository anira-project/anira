 ...
 * - **Non-streamable tensors**: Static parameters or control values stored in thread-safe internal
 * storage
 *
 * @par Key Features:
...
public:
     ...
     *
     * @param inference_config Reference to the inference configuration containing tensor
     * specifications
     */
     ...
     * @param current_inference_backend Currently active inference backend (for backend-specific
     * processing)
     *
