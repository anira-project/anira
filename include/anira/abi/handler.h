 ...
 * there. The handler is unprepared until prepare succeeds: every Hard entry returns 0
 * with ANIRA_ERROR_NOT_PREPARED in anira_handler_rt_error. The handler counts as a user
 * of the core until destroy.
