...
static std::vector<anira::ModelData> model_data_small_cnn_config = {
    ...
    {STEERABLENAFX_MODELS_PATH_PYTORCH +
         std::string("/model_0/steerable-nafx-2_blocks-libtorch-dynamic.onnx"),
     anira::InferenceBackend::ONNX},
#endif
#ifdef USE_TFLITE
    {STEERABLENAFX_MODELS_PATH_TENSORFLOW +
         std::string("/model_0/steerable-nafx-2_blocks-dynamic.tflite"),
    ...
    {STEERABLENAFX_MODELS_PATH_PYTORCH +
         std::string("/model_0/steerable-nafx-2_blocks-executorch.pte"),
...
#endif
#ifdef USE_LITERT
    {{{1, 2180, 1}}, {{1, 2048, 1}}, anira::InferenceBackend::LITERT},
#endif
#ifdef USE_EXECUTORCH
    {{{1, 1, 2180}}, {{1, 1, 2048}}, anira::InferenceBackend::EXECUTORCH},
#endif
};
...
static anira::InferenceConfig small_cnn_config(model_data_small_cnn_config,
