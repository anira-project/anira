...
static std::vector<anira::ModelData> model_data_cnn_config = {
    ...
    {STEERABLENAFX_MODELS_PATH_PYTORCH +
         std::string("/model_0/steerable-nafx-libtorch-dynamic.onnx"),
    ...
    {STEERABLENAFX_MODELS_PATH_PYTORCH + std::string("/model_0/steerable-nafx-executorch.pte"),
...
#endif
#ifdef USE_EXECUTORCH
    {{{1, 1, 15380}}, {{1, 1, 2048}}, anira::InferenceBackend::EXECUTORCH},
#endif
};
...
static anira::InferenceConfig cnn_config(model_data_cnn_config,
