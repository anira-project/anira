...
export const anira_stage_ctx = {
  ...
  fields: {
    ...
    input_rings: { offset: 32, size: 8, ptr: true },
    model_inputs: { offset: 40, size: 8, ptr: true },
    model_outputs: { offset: 48, size: 8, ptr: true },
    output_rings: { offset: 56, size: 8, ptr: true },
  },
} as const
